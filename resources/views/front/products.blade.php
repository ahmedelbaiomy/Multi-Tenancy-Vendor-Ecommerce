...
@section('content')
                                        ...
                                        @forelse($products as $product)
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-group-price">
                                                                <div class="product-price-and-shipping">
                                                                    <span itemprop="price "
                                                                          class="price float-left">{{$product -> special_price ?? $product -> price }} {{__('site/ar.L.E')}}</span>
                                                                    @if($product -> special_price)
                                                                        <span
                                                                            class="regular-price float-right">{{$product -> price}} {{__('site/ar.L.E')}}</span>
                                                                    @endif
                                            ...
                                            @empty
                                                <div class="text-center">
                                                    <p class="text-center"> There is no products founded</p>
                                                </div>
                                        @endforelse
                                    @endisset
                                </div>
    ...
    <span class='showing'>
    Showing 1-4 of {{count($products)}} item(s)
    </span>
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.quick-view', function () {
            $('.quickviews-modal-product-details-' + $(this).attr('data-product-id')).css("display", "block");
                $('.quickview ').css("display", "none");

        });
        $(document).on('click', '.close', function () {
            $('.quickviews-modal-product-details-' + $(this).attr('data-product-id')).css("display", "none");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.wished){
                        ...
                        $('.addToWishlist').attr("style", "background-color:#2d9ae8");
                    } else{
