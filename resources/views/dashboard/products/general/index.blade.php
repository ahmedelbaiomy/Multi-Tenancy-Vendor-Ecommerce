        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin\dashboard.Products')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin\dashboard.Home Page')}}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('admin\dashboard.Products')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin\dashboard.Products')}}</h4>
...
{{--                                                <th>{{__('admin\dashboard.image')}}</th>--}}
                                                <th>{{__('admin\dashboard.prices')}}</th>
                                            ...
                                            @isset($products)
                                                @foreach($products as $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$product->slug}}</td>
                                                        <td><span
                                                                class="badge badge badge-{{$product->getActive() ==  __('admin\dashboard.active')? 'success':'danger'}} badge-pill float-right mr-2">{{$product -> getActive()}}</span></td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.products.images',[$product -> id])}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{__('admin\dashboard.images')}}</a>
