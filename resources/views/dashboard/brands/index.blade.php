        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin\dashboard.brands')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin\dashboard.Home Page')}}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('admin\dashboard.brands')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin\dashboard.brands')}}</h4>
                                            ...
                                            @isset($brands)
                                                @foreach($brands as $brand)
                                                    <tr>
                                                        <td>{{$brand -> name}}</td>
                                                        <td><span
                                                                class="badge badge badge-{{$brand->getActive() ==  __('admin\dashboard.active')? 'success':'danger'}} badge-pill float-right mr-2">{{$brand -> getActive()}}</span></td>
