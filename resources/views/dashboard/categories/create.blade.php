                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.categories')}}"> {{__('admin\dashboard.Main Categories')}} </a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/dashboard.Add Main Category')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/dashboard.Add Main Category')}} </h4>
                                                                ...
                                                                <optgroup label="{{__('admin\dashboard.choose')}}">
                                                                    @if($categories && $categories->count() > 0)
                                                                        @foreach($categories as $category)
                                                                            <option
                                                                                value="{{$category -> id }}">
                                                                                {{$category->translations->where('locale',app()->getLocale())->first()->name ?? $category->translations->where('locale','en')->first()->name}}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
